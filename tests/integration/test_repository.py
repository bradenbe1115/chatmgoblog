...
def test_mgoblog_content_repository():
    ...
    data = [MgoblogContentLandingDataSchema(url="/url_one", raw_html="Hello World", collected_ts="2024-01-01"),
            MgoblogContentLandingDataSchema(url="/url_two", raw_html="Hello World Again", collected_ts="2024-02-01")]
    ...
    new_data = [MgoblogContentLandingDataSchema(url="/url_one", raw_html="Hello World - Test Update", collected_ts="2024-01-01")]
